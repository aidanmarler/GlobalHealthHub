...
>
	...
	<div>
		<h1
			class="mb-4 flex items-center border-b-[5px] border-cgh_border_grey bg-white p-3 text-3xl font-thin text-black"
		>
			<img
		...
		<div class="h-full w-full px-1">
			{#if currentViewportState.scale == ViewportScale.Project}
				...
				<h3>
					Mission: <span
						class="border-b-4"
						style="border-color: {missionColors[Mission.Education]};"
